...
test_issue = Issue(title="Division by Zero", body="The calculator application crashes when a user attempts to divide by zero or calculate the square root of a negative number.")

test_file_list = [file1, file2]
